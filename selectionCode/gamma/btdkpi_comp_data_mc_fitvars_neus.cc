...
void btdkpi_comp_data_mc_fitvars_neus(TString channel="D0K", TString dstar0mode="d0", TString d0mode="kspipi",Int_t cut=-999)
{
...
//     cout << endl << "title = " << title<<endl;
    ...
    TString name_sig="ASCII/"+sdec+dstar0mode+KorPi+"_"+d0mode+"_"+sig_type+"_Bbest_"+cut_code_str+".root";
    ...
    // chb
    sig_type = "chb"; 
    TString name_chb="ASCII/"+sdec+dstar0mode+KorPi+"_"+d0mode+"_"+sig_type+"_Bbest_"+cut_code_str+".root";
    ...
    TString name_chbkpi="ASCII/"+sdec+dstar0mode+KorPi+"_"+d0mode+"_"+sig_type+"_Bbest_"+cut_code_str+".root";
    ...
    THStack* stack=new THStack("data_mc","");
    ...
    //if (type==mes || type==demk) leg = new TLegend(0.17,0.40,0.40,0.87);//meskspipi good
    //    if (type==mes || type==demk) leg = new TLegend(0.21,0.40,0.40,0.92);
     if (type==mes || type==demk) leg = new TLegend(0.70,0.40,0.85,0.87) ;//demk kspipi
