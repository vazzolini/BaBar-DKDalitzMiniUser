...
class btdkpi_final {
  ...
  //matching 
  Bool_t isMcDstar0Matchedfunction(Int_t a);
  Bool_t isMcDstar0Matchedfunction_matchedB(Int_t a, TString KorPi);
  Bool_t isMcD0Matchedfunction(Int_t a);
  Bool_t isMcD0Matchedfunction_matchedB(Int_t a, TString KorPi);
  Bool_t isMcprMatchedfunction(Int_t a, TString KorPi);
  Bool_t isMcBMatchedfunction (Int_t a, TString KorPi);
};
...
{  
 ...
 // ST 536870912
  ...
  //CUT114 for final fitting: all cuts except fisher and mes (fractions of D0)
