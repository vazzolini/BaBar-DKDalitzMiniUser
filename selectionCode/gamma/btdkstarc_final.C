...
void btdkstarc_final::LoopBest(Int_t cut_code, Long64_t nentries, Int_t opt)
{
  ...
  TString outname_matchedB="ASCII/"+sdec+_Kstarc_decay+"_"+_d0mode+"_"+_sig_type+"_Bbest_"+TString(cut_code_str)+"_matchedB.dat";
  TString outname_fakeBfakepr="ASCII/"+sdec+_Kstarc_decay+"_"+_d0mode+"_"+_sig_type+"_Bbest_"+TString(cut_code_str)+"_fakeBfakepr.dat";
  TString outname_fakeBfakeD="ASCII/"+sdec+_Kstarc_decay+"_"+_d0mode+"_"+_sig_type+"_Bbest_"+TString(cut_code_str)+"_fakeBfakeD.dat";
  TString outname_fakeBtruepr="ASCII/"+sdec+_Kstarc_decay+"_"+_d0mode+"_"+_sig_type+"_Bbest_"+TString(cut_code_str)+"_fakeBtruepr.dat";
  TString outname_fakeBtrueD="ASCII/"+sdec+_Kstarc_decay+"_"+_d0mode+"_"+_sig_type+"_Bbest_"+TString(cut_code_str)+"_fakeBtrueD.dat";
  TString outname_fakeB="ASCII/"+sdec+_Kstarc_decay+"_"+_d0mode+"_"+_sig_type+"_Bbest_"+TString(cut_code_str)+"_fakeB.dat";
  ...
  for (Int_t jentry=0; jentry<nentries;jentry++) {
	...
	if (opt==1){	    
	  ...
	  // (actualisMcD0id==421 && actuallundVectorc==-323)) )
	  if(isMcD0Matchedfunction(actualisMcD0Matched))
	    //((actualMcEvtType&3841==3841 || actualMcEvtType&3842==3842) &&
  ...
  //B Truth matched
	  ...
	  if(isMcBMatchedfunction(actualMcEvtType))
	    outfile_matchedB<<"1"<<" "<< bdecay_type_code+200+100*_Kstarc_decay_code+ddecay_code <<" "<< actualchargeb<<" " 
			    << actualq12  << " " << actualq13 << " " << actualq23 << " " 
			    <<actualchargeB_truth << " " <<actualq12_truth << " " << actualq13_truth<< " " << actualq23_truth<< " "
			    <<actualdemk << " " << actualppr << " " << actualbeta_Gamma<< " " 
			    <<actualmes << " " << actualmassD0 << " " <<" " << actualfisherDK<< " " 
	  ...
	  if(!isMcBMatchedfunction(actualMcEvtType)){
	    outfile_fakeB<<"1"<<" "<< bdecay_type_code+200+100*_Kstarc_decay_code+ddecay_code <<" "<< actualchargeb<<" " 
			 << actualq12  << " " << actualq13 << " " << actualq23 << " " 
			 <<actualchargeB_truth << " " <<actualq12_truth << " " << actualq13_truth<< " " << actualq23_truth<< " "
			 <<actualdemk << " " << actualppr << " " << actualbeta_Gamma<< " " 
			 <<actualmes << " " << actualmassD0 << " " <<" " << actualfisherDK<< " " 
	    ...
	    if(!(isMcprMatchedfunction(actualMcEvtType)))
	      outfile_fakeBfakepr<<"1"<<" "<< bdecay_type_code+200+100*_Kstarc_decay_code+ddecay_code <<" "<< actualchargeb<<" " 
				 << actualq12  << " " << actualq13 << " " << actualq23 << " " 
				 <<actualchargeB_truth << " " <<actualq12_truth << " " << actualq13_truth<< " " << actualq23_truth<< " "
				 <<actualdemk << " " << actualppr << " " << actualbeta_Gamma<< " " 
				 <<actualmes << " " << actualmassD0 << " " <<" " << actualfisherDK<< " " 
	    ...
	    if(!(isMcD0Matchedfunction(actualMcEvtType)))
	      outfile_fakeBfakeD<<"1"<<" "<< bdecay_type_code+200+100*_Kstarc_decay_code+ddecay_code <<" "<< actualchargeb<<" " 
				<< actualq12  << " " << actualq13 << " " << actualq23 << " " 
				<<actualchargeB_truth << " " <<actualq12_truth << " " << actualq13_truth<< " " << actualq23_truth<< " "
				<<actualdemk << " " << actualppr << " " << actualbeta_Gamma<< " " 
				<<actualmes << " " << actualmassD0 << " " <<" " << actualfisherDK<< " " 
	    ...
	    if((isMcprMatchedfunction(actualMcEvtType)))
	      outfile_fakeBtruepr<<"1"<<" "<< bdecay_type_code+200+100*_Kstarc_decay_code+ddecay_code <<" "<< actualchargeb<<" " 
				 << actualq12  << " " << actualq13 << " " << actualq23 << " " 
				 <<actualchargeB_truth << " " <<actualq12_truth << " " << actualq13_truth<< " " << actualq23_truth<< " "
				 <<actualdemk << " " << actualppr << " " << actualbeta_Gamma<< " " 
				 <<actualmes << " " << actualmassD0 << " " <<" " << actualfisherDK<< " " 
	    ...
	    if((isMcD0Matchedfunction(actualMcEvtType)))
	      outfile_fakeBtrueD<<"1"<<" "<< bdecay_type_code+200+100*_Kstarc_decay_code+ddecay_code <<" "<< actualchargeb<<" " 
				<< actualq12  << " " << actualq13 << " " << actualq23 << " " 
				<<actualchargeB_truth << " " <<actualq12_truth << " " << actualq13_truth<< " " << actualq23_truth<< " "
				<<actualdemk << " " << actualppr << " " << actualbeta_Gamma<< " " 
				<<actualmes << " " << actualmassD0 << " " <<" " << actualfisherDK<< " " 
...
// Bool_t btdkstarc_final::isMcBMatchedfunction(Int_t a)
// {
//   Int_t out(0);
...
Bool_t btdkstarc_final::isMcBMatchedfunction(Int_t a)
{
  ...
  if(isMcprMatchedfunction(a) && isMcD0Matchedfunction(a))
    out=1;
  else out=0;
