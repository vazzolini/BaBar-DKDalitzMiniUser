...
public :
   ...
   btdkstarc_final(TString Kstarc_decay, TString d0mode, TString sig_type, TString release="analysis-51", Bool_t isCS=kFALSE, Bool_t doReadRootuples=kTRUE);
   ...
   Bool_t isMcD0Matchedfunction(Int_t a);
   Bool_t isMcprMatchedfunction(Int_t a);
   Bool_t  isMcBMatchedfunction(Int_t a);
...
btdkstarc_final::btdkstarc_final(TString Kstarc_decay, TString d0mode, TString sig_type, TString release, Bool_t isCS, Bool_t doReadRootuples)
{
  ...
  if (release=="analysis-51") filename_root="./reduced/";
  // if (release=="analysis-51") filename_root="./root/";
  ...
  if (_sig_type=="uds") {
    ...
    cout << "filename : " << filename << endl;
    tree->Add(filename);
    filename=filename_root+"chbNR6.root";
    cout << "filename : " << filename << endl;
    tree->Add(filename);
    ...
    cout << "filename : " << filename << endl;
    tree->Add(filename);
    filename=filename_root+"chbR6.root";
    cout << "filename : " << filename << endl;
    tree->Add(filename);
...
/*     cout << "filename : " << filename << endl; */
/*     tree->Add(filename); */
/*     filename=filename_root+"On4_1.root"; */
/*     cout << "filename : " << filename << endl; */
/*     tree->Add(filename); */
/*     filename=filename_root+"On4_29.root"; */
/*     cout << "filename : " << filename << endl; */
/*     tree->Add(filename); */
/*     filename=filename_root+"On5_1.root"; */
/*     cout << "filename : " << filename << endl; */
/*     tree->Add(filename); */
/*     filename=filename_root+"On5_24.root"; */
/*     cout << "filename : " << filename << endl; */
/*     tree->Add(filename); */
/*     filename=filename_root+"On5_59.root"; */
/*     cout << "filename : " << filename << endl; */
/*     tree->Add(filename); */
/*     filename=filename_root+"On6.root"; */
/*     cout << "filename : " << filename << endl; */
...
/*     tree->Add(filename); */
    ...
    cout << "filename : " << filename << endl;
    tree->Add(filename);
    filename=filename_root+_sig_type+"6.root";
    cout << "filename : " << filename << endl;
    tree->Add(filename);
...
Int_t btdkstarc_final::Cut(Int_t cut_code, Bool_t Mctruth, Float_t fisher)
{
  ...
  // cut_code =    1     2      3         4       5       6           7kspi     7kpi0        8         9        10          11         12           13          14
  //              mes   demk   massD0  massKs    cosKs   cosKstarKs  SigDlks    kaonid    costhrust coshel massKstarc massVectorcReso m0KstarcPi0  probchi2D0  probchi2ChB
  //               
  ...
  Float_t demk_cut = (_Kstarc_decay_code==1) ? 0.030 : 0.036;   // resolution: 0.011 : 0.018
  ...
  Float_t mVectorcReso_nom=(_isCS==kFALSE) ? 0.4976: 0.770;
  ...
  if (
      ...
      ((cut_code==111 || cut_code==112||cut_code==114 || cut_code==113)? kTRUE : fisher>=fisher_cut)
      )
    return 1;
...
/* 	  : kTRUE) */
/* 	 && */
/* 	 (cut_code==104? ((chi2D0>=0. && probchi2D0>probchi2D0_cut) */
/* 			  && (fabs(massD0-mD0_nom)<deltamD0_cut) */
/* 			  && (fabs(massKs-mKs_nom)<deltamKs_cut)) */
/* 	  : kTRUE) */
/* 	 && */
/* 	 (cut_code==105? (cosKs>cosKs_cut */
/* 			  &&(chi2D0>=0. && probchi2D0>probchi2D0_cut) */
/* 			  && (fabs(massD0-mD0_nom)<deltamD0_cut) */
/* 			  && (fabs(massKs-mKs_nom)<deltamKs_cut)) */
/* 	  : kTRUE) */
/* 	 && */
/* 	 (cut_code==106? ((chi2ChB>=0. && probchi2ChB>probchi2ChB_cut) */
/* 			  && cosKs>cosKs_cut */
/* 			  && (chi2D0>=0. && probchi2D0>probchi2D0_cut) */
/* 			  && (fabs(massD0-mD0_nom)<deltamD0_cut) */
/* 			  && (fabs(massKs-mKs_nom)<deltamKs_cut)) */
/* 	  : kTRUE) */
/* 	 && */
/* 	 (cut_code==107? ((fabs(massVectorcReso-mVectorcReso_nom)<deltamVectorcReso_cut) */
...
/* 	 : kTRUE) */
/* 	&& */
/* 	(cut_code==108? (cosVectorcReso>cosVectorcReso_cut */
...
/* 	 : kTRUE) */
/*      && */
/* 	(cut_code==109? ((fabs(massVectorc-mVectorc_nom)<deltamVectorc_cut) */
/* 			 && cosVectorcReso>cosVectorcReso_cut */
/* 			 &&(fabs(massVectorcReso-mVectorcReso_nom)<deltamVectorcReso_cut) */
/* 			 &&(chi2ChB>=0. && probchi2ChB>probchi2ChB_cut) */
/* 			 && (chi2D0>=0. && probchi2D0>probchi2D0_cut) */
/* 			 && cosKs>cosKs_cut */
...
/* 	 : kTRUE) */
/* 	&& */
/* 	(cut_code==110? ((fabs(coseliVectorc)>coshel_cut) */
/* 			 &&(fabs(massVectorc-mVectorc_nom)<deltamVectorc_cut) */
/* 			 && cosVectorcReso>cosVectorcReso_cut */
/* 			 &&(fabs(massVectorcReso-mVectorcReso_nom)<deltamVectorcReso_cut) */
/* 			 &&(chi2ChB>=0. && probchi2ChB>probchi2ChB_cut) */
/* 			 && (chi2D0>=0. && probchi2D0>probchi2D0_cut) */
...
/* 	 : kTRUE) */
/* 	&& */
/* 	(cut_code==111? ((SigdlKs>= SigdlKs_cut) */
/* 			 &&(fabs(coseliVectorc)>coshel_cut) */
/* 			 &&(fabs(massVectorc-mVectorc_nom)<deltamVectorc_cut) */
/* 			 && cosVectorcReso>cosVectorcReso_cut */
/* 			 &&(fabs(massVectorcReso-mVectorcReso_nom)<deltamVectorcReso_cut) */
/* 			 &&(chi2ChB>=0. && probchi2ChB>probchi2ChB_cut) */
...
/* 	 : kTRUE) */
/* 	&& */
/* 	(cut_code==112? (fisher>=fisher_cut */
/* 			 &&(SigdlKs>= SigdlKs_cut) */
/* 			 &&(fabs(coseliVectorc)>coshel_cut) */
/* 			 &&(fabs(massVectorc-mVectorc_nom)<deltamVectorc_cut) */
/* 			 && cosVectorcReso>cosVectorcReso_cut */
...
/* 	 : kTRUE) */
/* 	&& */
/* 	(cut_code==113? (fabs(demk2)<demk_cut */
/* 			 &&fisher>=fisher_cut */
/* 			 &&(SigdlKs>= SigdlKs_cut) */
/* 			 &&(fabs(coseliVectorc)>coshel_cut) */
/* 			 &&(fabs(massVectorc-mVectorc_nom)<deltamVectorc_cut) */
