...
class btdkstarc {
 ...
 public:
  ...
  btdkstarc(TString type,TString dmode="kspipi",const char* dir=0, const char* release="analysis-51", Bool_t isCS = kFALSE); 
  ~btdkstarc();

  Bool_t isBtoDVectorc(Int_t lundD0Trk,Int_t i,Bool_t isCS);     
  Int_t  isSignalEvt(Int_t lundD0Trk,Int_t idKstar,Int_t i_ChB);  
  Int_t isSignalEvt2(Int_t,Int_t,Int_t);
  Int_t indexMuonDaughter( Int_t index );
  Bool_t matchAMuon( Int_t matchedIndex, Int_t mcIndex );
...
/*       if (dir==0) filename+="./rootuples/rootSigMCst/";     */
...
/*       tree->Add(filename); */
/*     } */
    if (_sig_type=="btdkstarc1" && _d0mode=="kspipi"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
    ...
    else if (_sig_type=="btdkstarc2" && _d0mode=="kspipi"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
    ...
    else if (_sig_type=="btdkstarc3" && _d0mode=="kspipi"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
    ...
    else if (_sig_type=="btdkstarc4" && _d0mode=="kspipi"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
    ...
    else if (_sig_type=="btdkstarc5" && _d0mode=="kspipi"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
    ...
    else if (_sig_type=="btdkstarc6" && _d0mode=="kspipi"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
      filename+="SP-6364-Run6-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }
    ...
    if (_sig_type=="btdkstarc1" && _d0mode=="kskk"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
      filename+="SP-8492-Run1-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
      
    }
    else if (_sig_type=="btdkstarc2" && _d0mode=="kskk"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
      filename+="SP-8492-Run2-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
      
    }
    else if (_sig_type=="btdkstarc3" && _d0mode=="kskk"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
      filename+="SP-8492-Run3-*.root";    
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
      
    }
    else if (_sig_type=="btdkstarc4" && _d0mode=="kskk"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
      filename+="SP-8492-Run4-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);

    }
    else if (_sig_type=="btdkstarc5" && _d0mode=="kskk"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
      filename+="SP-8492-Run5-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);

    }
    else if (_sig_type=="btdkstarc6" && _d0mode=="kskk"){
      _super_sig_type="btdkstarc";
      if (dir==0) filename+="./rootuples/rootSigMCst/";
      filename+="SP-8492-Run6-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    ...
    }else if (_sig_type=="btda1" && _d0mode=="kskk"){
      _isCS = kTRUE;
      if (dir==0) filename+="./rootuples/root6340/";  
      filename+="SP-6340-*.root";        
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }

  else if (_sig_type=="btda1" && _d0mode=="kspipi"){
      _isCS = kTRUE;
      if (dir==0) filename+="./rootuples/root6340/";  
      filename+="SP-6340-*.root";        
      cout<<"loading root file " << filename << endl;
 ...
 // Signal (R and NR) from generic MC
      ...
      if (dir==0) filename+="./rootuples/root1235st/";
      filename+="SP-1235-BchToD0KstarAll-Run1-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="chbR2" || _sig_type=="chbNR2"){
      _super_sig_type=(_sig_type=="chbR2")? "chbR" : "chbNR";
      if (dir==0) filename+="./rootuples/root1235st/";
      filename+="SP-1235-BchToD0KstarAll-Run2-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="chbR3" || _sig_type=="chbNR3"){
      _super_sig_type=(_sig_type=="chbR3")? "chbR" : "chbNR";
      if (dir==0) filename+="./rootuples/root1235st/";
      filename+="SP-1235-BchToD0KstarAll-Run3-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="chbR4" || _sig_type=="chbNR4"){
      _super_sig_type=(_sig_type=="chbR4")? "chbR" : "chbNR";
      if (dir==0) filename+="./rootuples/root1235st/";
      filename+="SP-1235-BchToD0KstarAll-Run4-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="chbR5" || _sig_type=="chbNR5"){
      _super_sig_type=(_sig_type=="chbR5")? "chbR" : "chbNR";
      if (dir==0) filename+="./rootuples/root1235st/";
      filename+="SP-1235-BchToD0KstarAll-Run5-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="chbR6" || _sig_type=="chbNR6"){
      _super_sig_type=(_sig_type=="chbR6")? "chbR" : "chbNR";
      if (dir==0) filename+="./rootuples/root1235st/";
      filename+="SP-1235-BchToD0KstarAll-Run6-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }
    ...
    //b0b0bar
      ...
      if (dir==0) filename+="./rootuples/root1237st/";
      filename+="SP-1237-BchToD0KstarAll-Run1-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="b0b0bar2"){
      _super_sig_type="b0b0bar";
      if (dir==0) filename+="./rootuples/root1237st/";
      filename+="SP-1237-BchToD0KstarAll-Run2-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="b0b0bar3"){
      _super_sig_type="b0b0bar";
      if (dir==0) filename+="./rootuples/root1237st/";
      filename+="SP-1237-BchToD0KstarAll-Run3-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="b0b0bar4"){
      _super_sig_type="b0b0bar";
      if (dir==0) filename+="./rootuples/root1237st/";
      filename+="SP-1237-BchToD0KstarAll-Run4-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="b0b0bar5"){
      _super_sig_type="b0b0bar";
      if (dir==0) filename+="./rootuples/root1237st/";
      filename+="SP-1237-BchToD0KstarAll-Run5-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="b0b0bar6"){
      _super_sig_type="b0b0bar";
      if (dir==0) filename+="./rootuples/root1237st/";
      filename+="SP-1237-BchToD0KstarAll-Run6-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }
    ...
    //ccbar
      ...
      if (dir==0) filename+="./rootuples/root1005st/";
      filename+="SP-1005-BchToD0KstarAll-Run1-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="ccbar2"){
      _super_sig_type="ccbar";
      if (dir==0) filename+="./rootuples/root1005st/";
      filename+="SP-1005-BchToD0KstarAll-Run2-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="ccbar3"){
      _super_sig_type="ccbar";
      if (dir==0) filename+="./rootuples/root1005st/";
      filename+="SP-1005-BchToD0KstarAll-Run3-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="ccbar4"){
      _super_sig_type="ccbar";
      if (dir==0) filename+="./rootuples/root1005st/";
      filename+="SP-1005-BchToD0KstarAll-Run4-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
      ...
      _super_sig_type="ccbar";
      if (dir==0) filename+="./rootuples/root1005st/";
      filename+="SP-1005-BchToD0KstarAll-Run5-R24a1-v03-1*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="ccbar5_29"){
      _super_sig_type="ccbar";
      if (dir==0) filename_root="./rootuples/root1005st/";
      for(Int_t i=2; i<10;i++){
	sprintf(mystring,"%i",i);
	filename=filename_root+"SP-1005-BchToD0KstarAll-Run5-R24a1-v03-"+mystring+"*.root";
	tree->Add(filename);
	cout << "filename : " << filename << endl;}
      ...
      _super_sig_type="ccbar";
      if (dir==0) filename+="./rootuples/root1005st/";
      filename+="SP-1005-BchToD0KstarAll-Run6-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }
    ...
    //uds
      ...
      _super_sig_type="uds";
      if (dir==0) filename+="./rootuples/root998st/";
      filename+="SP-998-BchToD0KstarAll-Run1-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="uds2"){
      _super_sig_type="uds";
      if (dir==0) filename+="./rootuples/root998st/";
      filename+="SP-998-BchToD0KstarAll-Run2-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="uds3"){
      _super_sig_type="uds";
      if (dir==0) filename+="./rootuples/root998st/";
      filename+="SP-998-BchToD0KstarAll-Run3-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="uds4"){
      _super_sig_type="uds";
      if (dir==0) filename+="./rootuples/root998st/";
      filename+="SP-998-BchToD0KstarAll-Run4-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="uds5"){
      _super_sig_type="uds";
      if (dir==0) filename+="./rootuples/root998st/";
      filename+="SP-998-BchToD0KstarAll-Run5-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="uds6"){
      _super_sig_type="uds";
      if (dir==0) filename+="./rootuples/root998st/";
      filename+="SP-998-BchToD0KstarAll-Run6-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }
...
/*       _super_sig_type="On"; */
/*       _isData = kTRUE; */
/*       if (dir==0) filename+="./rootuples/rootOn1st/"; */
/*       filename+="BchToD0KstarAll-Run1-OnPeak-*.root"; */
/*       cout<<"loading root file " << filename << endl; */
/*       tree->Add(filename); */
/*     } else if (_sig_type=="On2"){ */
/*       _super_sig_type="On"; */
/*       _isData = kTRUE; */
/*       if (dir==0) filename+="./rootuples/rootOn2st/"; */
/*       filename+="BchToD0KstarAll-Run2-OnPeak-*.root"; */
/*       cout<<"loading root file " << filename << endl; */
/*       tree->Add(filename); */
/*     }else if (_sig_type=="On3"){ */
/*       _super_sig_type="On"; */
/*       _isData = kTRUE; */
/*       if (dir==0) filename+="./rootuples/rootOn3st/"; */
/*       filename+="BchToD0KstarAll-Run3-OnPeak-*.root"; */
/*       cout<<"loading root file " << filename << endl; */
/*       tree->Add(filename); */
/*     }else if (_sig_type=="On4"){ */
/*       _super_sig_type="On"; */
/*       _isData = kTRUE; */
/*       if (dir==0) filename+="./rootuples/rootOn4st/"; */
/*       filename+="BchToD0KstarAll-Run4-OnPeak-*.root"; */
/*       cout<<"loading root file " << filename << endl; */
/*       tree->Add(filename); */
/*     }else if (_sig_type=="On5"){ */
/*       _super_sig_type="On"; */
/*       _isData = kTRUE; */
/*       if (dir==0) filename+="./rootuples/rootOn5st/"; */
/*       filename+="BchToD0KstarAll-Run5-OnPeak-*.root"; */
/*       cout<<"loading root file " << filename << endl; */
/*       tree->Add(filename); */
/*     }else if (_sig_type=="On6"){ */
/*       _super_sig_type="On"; */
/*       _isData = kTRUE; */
/*       if (dir==0) filename+="./rootuples/rootOn6st/"; */
/*       filename+="BchToD0KstarAll-Run6-OnPeak-*.root"; */
/*       cout<<"loading root file " << filename << endl; */
/*       tree->Add(filename); */
/*     } */
    ...
    //Off
      ...
      _super_sig_type="Off";
      _isData = kTRUE;
      if (dir==0) filename+="./rootuples/rootOff1st/";
      filename+="BchToD0KstarAll-Run1-OffPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    } else if (_sig_type=="Off2"){
      _super_sig_type="Off";
      _isData = kTRUE;
      if (dir==0) filename+="./rootuples/rootOff2st/";
      filename+="BchToD0KstarAll-Run2-OffPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="Off3"){
      _super_sig_type="Off";
      _isData = kTRUE;
      if (dir==0) filename+="./rootuples/rootOff3st/";
      filename+="BchToD0KstarAll-Run3-OffPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="Off4"){
      _super_sig_type="Off";
      _isData = kTRUE;
      if (dir==0) filename+="./rootuples/rootOff4st/";
      filename+="BchToD0KstarAll-Run4-OffPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="Off5"){
      _super_sig_type="Off";
      _isData = kTRUE;
      if (dir==0) filename+="./rootuples/rootOff5st/";
      filename+="BchToD0KstarAll-Run5-OffPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }else if (_sig_type=="Off6"){
      _super_sig_type="Off";
      _isData = kTRUE;
      if (dir==0) filename+="./rootuples/rootOff6st/";
      filename+="BchToD0KstarAll-Run6-OffPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    }
    else if (_sig_type=="On1"){
      ...
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename+="./rootuples/rootOn1_a1/";
      filename+="BRecoToDDstar-Run1-OnPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    } 
    else if (_sig_type=="On2"){
      ...
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename+="./rootuples/rootOn2_a1/";
      filename+="BRecoToDDstar-Run2-OnPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    } 
    else if (_sig_type=="On3"){
      ...
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename+="./rootuples/rootOn3_a1/";
      filename+="BRecoToDDstar-Run3-OnPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    } 
    else if (_sig_type=="On4_1"){
      _super_sig_type="On";
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename_root="./rootuples/rootOn4_a1/";
      filename=filename_root+"BRecoToDDstar-Run4-OnPeak-R24a1-v03-1*.root";
      tree->Add(filename);
      cout << "filename : " << filename << endl;
      
    }else if(_sig_type== "On4_24"){
      _super_sig_type="On";
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename_root="./rootuples/rootOn4_a1/";
      for(Int_t i=2; i<5;i++){
	sprintf(mystring,"%i",i);
	filename=filename_root+"BRecoToDDstar-Run4-OnPeak-R24a1-v03-"+mystring+"*.root";
	tree->Add(filename);
	cout << "filename : " << filename << endl;}
      
    }else if(_sig_type== "On4_59"){
      _super_sig_type="On";
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename_root="./rootuples/rootOn4_a1/";
	...
	cout << "filename : " << filename << endl;}
    ...
    } else if (_sig_type=="On5_1"){
      _super_sig_type="On";
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename_root="./rootuples/rootOn5_a1/";
      filename=filename_root+"BRecoToDDstar-Run5-OnPeak-R24a1-v03-1*.root";
      tree->Add(filename);
      cout << "filename : " << filename << endl;
      
    }else if(_sig_type== "On5_24"){
      _super_sig_type="On";
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename_root="./rootuples/rootOn5_a1/";
      for(Int_t i=2; i<5;i++){
	sprintf(mystring,"%i",i);
	filename=filename_root+"BRecoToDDstar-Run5-OnPeak-R24a1-v03-"+mystring+"*.root";
	tree->Add(filename);
	cout << "filename : " << filename << endl;}
  
    }else if(_sig_type== "On5_59"){
      _super_sig_type="On";
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename_root="./rootuples/rootOn5_a1/";
	...
	cout << "filename : " << filename << endl;}
      ...
      _isData = kTRUE;
      _isCS = kTRUE;
      if (dir==0) filename+="./rootuples/rootOn6_a1/";
      filename+="BRecoToDDstar-Run6-OnPeak-*.root";
      cout<<"loading root file " << filename << endl;
      tree->Add(filename);
    } 
