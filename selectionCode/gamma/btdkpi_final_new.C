	...
	if (!isfirst)
	  {
		...
		*/
		...
		if ( (actualisMcD0id==421 && actuallundpr==-321) || (actualisMcD0id==-421 && actuallundpr==321) ) totprRSbc++;
	      ...
	      if (isMcD0Matchedfunction(actualisMcD0Matched)) {
		if( isMcDstar0Matchedfunction(actualMcEvtType) && isMcprMatchedfunction(actualMcEvtType) )RightSignalbc++; 
		if( isMcDstar0Matchedfunction(actualMcEvtType) && !isMcprMatchedfunction(actualMcEvtType) ){
		  WSignalbc++;
		  if((actualisMcD0id==-421 && actuallundpr==321) || (actualisMcD0id==421 && actuallundpr==-321))  RSignWSignalbc++;
		}
...
Bool_t btdkpi_final::isMcprMatchedfunction(Int_t a)
{
